...
write.csv(pbmc@meta.data,file="pbmc_meta.data.ref3_fine.csv")
...
saveRDS(pbmc, file="sample.combined_T10_singleR_ref3_fine.rds")
pdf("umap_singleR_ref3_dimplot_fine.pdf")
DimPlot(pbmc, reduction = "umap", group.by = "singleR")
dev.off()
pdf("tsne_singleR_ref3_dimplot_fine.pdf")
DimPlot(pbmc, reduction = "tsne", group.by = "singleR")
dev.off()

pdf("umap_Response_singleR_ref3_dimplot_fine.pdf")
DimPlot(pbmc, reduction = "umap", group.by = "singleR",split.by = 'Response')
dev.off()
pdf("tsne_Response_singleR_ref3_dimplot_fine.pdf")
