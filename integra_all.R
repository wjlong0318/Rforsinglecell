...
in1<- readRDS("IntegrateSample_T10.rds")
print("load sample.combined_T10.rds complete...\n")
in2<- readRDS("IntegrateSample_Tothers.rds")
print("load IntegrateSample_Tothers.rds complete...\n")
sample.anchors <- FindIntegrationAnchors(object.list = list(
  in1,in2
), dims = 1:50)
print("FindIntegrationAnchors complete...\n")
sample.combined <- IntegrateData(anchorset = sample.anchors, dims = 1:50)
print("IntegrateData complete...\n")
saveRDS(sample.combined, file="sample.combined_T10_Tothers.rds")
print("SaveData complete...\n")
print("Start tsne and umap...\n")
...
#write.csv(pbmc@meta.data,file="pbmc_T10_others_meta.data.ref3_fine.csv")
...
write.csv(pbmc@meta.data,file="pbmc_T10_others_meta.data.ref3_main_fine.csv")
saveRDS(pbmc, file="sample.combined_T10_others_singleR_ref3_main_fine.rds")

print("start write pdf..." )
pdf("umap_T10_others_singleR2_ref3_dimplot.pdf")
DimPlot(pbmc, reduction = "umap", group.by = "singleR2")
dev.off()
pdf("tsne_T10_others_singleR2_ref3_dimplot.pdf")
DimPlot(pbmc, reduction = "tsne", group.by = "singleR2")
dev.off()

pdf("umap_T10_others_Response_singleR2_ref3_dimplot.pdf")
DimPlot(pbmc, reduction = "umap", group.by = "singleR2",split.by = 'Response')
dev.off()
pdf("tsne_T10_others_Response_singleR2_ref3_dimplot.pdf")
...
pdf("umap_T10_others_singleR2_ref3_dimplot_fine.pdf")
DimPlot(pbmc, reduction = "umap", group.by = "singleR.main2")
dev.off()
pdf("tsne_T10_others_singleR2_ref3_dimplot_fine.pdf")
DimPlot(pbmc, reduction = "tsne", group.by = "singleR.main2")
dev.off()

pdf("umap_Response_T10_others_singleR2_ref3_dimplot_fine.pdf")
DimPlot(pbmc, reduction = "umap", group.by = "singleR.main2",split.by = 'Response')
dev.off()
pdf("tsne_Response_T10_others_singleR2_ref3_dimplot_fine.pdf")
