...
DimPlot(object = nCoV.integrated, reduction = 'umap',label = FALSE, group.by = 'Response')
dev.off()
pdf("DimCluster_Treatment.pdf")
DimPlot(object = nCoV.integrated, reduction = 'umap',label = FALSE, group.by = 'Treatment')
dev.off()
pdf("DimCluster_Gender.pdf")
DimPlot(object = nCoV.integrated, reduction = 'umap',label = FALSE, group.by = 'Gender')
dev.off()
pdf("DimSplit_Response.pdf")
DimPlot(object = nCoV.integrated, reduction = 'umap',label = FALSE, split.by = 'Response')
dev.off()
pdf("DimSplit_Treatment.pdf")
DimPlot(object = nCoV.integrated, reduction = 'umap',label = FALSE, split.by = 'Treatment')
dev.off()
pdf("DimSplit_Gender.pdf")
DimPlot(object = nCoV.integrated, reduction = 'umap',label = FALSE, split.by = 'Gender')
dev.off()
